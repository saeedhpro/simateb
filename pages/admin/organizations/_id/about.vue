  ...
  <div class="organization-page">
    ...
    <v-row>
      <v-col
        cols="12"
      >
        <admin-organization-about-component
          v-if="organization"
          :organization="organization"
        />
      </v-col>
...
import AdminOrganizationAboutComponent from "~/components/admin/organization/about/AdminOrganizationAboutComponent";

export default {
  name: "ShowOrganizationComponent.vue",
  components: {
    AdminOrganizationAboutComponent,
