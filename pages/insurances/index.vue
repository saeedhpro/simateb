...
export default {
  ...
  methods: {
    ...
    getInsuranceList() {
      this.$store.dispatch('insurances/getOwnInsurances', this.search)
    },
    ...
    createInsurance() {
      const type = this.create ? 'insurances/createOwnInsurance' : 'insurances/updateOwnInsurance'
      const data = {
        ...this.form,
    ...
    deleteInsurances(ids) {
      this.$store.dispatch('insurances/deleteInsurance', {
        ids
      })
        .then(() => {
          setTimeout(() => {
    ...
    removeItem() {
      ...
      this.$store.dispatch('insurances/removeOwnInsurance', this.selectedItem)
        .finally(() => {
          setTimeout(() => {
            this.toggleRemoveItemModal()
            this.getInsuranceList()
  ...
  computed: {
    insurances() {
      return this.$store.getters['insurances/getOwnInsuranceList']
    },
    allInsurances() {
